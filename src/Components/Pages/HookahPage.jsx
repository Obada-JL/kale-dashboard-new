...
const HookahPage = () => {
    ...
    const handleAddProduct = async (e) => {
        ...
        try {
            setIsLoading(true);
            await apiService.hookahs.add(newProduct);
            setNewProduct({
                name: '',
                nameTr: '',
                price: '',
    ...
    const handleAddImage = async (e) => {
        ...
        try {
            ...
            await apiService.images.hookah.add(formData);
            setImageFile(null);
            setSelectedCategory('');
    ...
    const handleDeleteImage = async (imageId) => {
        ...
        try {
            setIsLoading(true);
            await apiService.images.hookah.delete(imageId);
            await fetchImages();
    ...
    const handleExportProducts = () => {
        try {
            const success = exportToExcel(filteredProducts, 'hookahs', 'الأراكيل');
            if (success) {
                toast.success('تم تصدير الأراكيل بنجاح');
            } else {
                toast.error('فشل في تصدير الأراكيل');
            }
        } catch (error) {
    ...
    const handleExportImages = () => {
        try {
            const success = exportImagesToExcel(filteredImages, 'hookah-images', 'الأراكيل');
            if (success) {
    ...
    const handleExportCategories = () => {
        try {
            const success = exportCategoriesToExcel(categories, 'hookah-categories');
            if (success) {
                        ...
                        <div className="d-flex gap-2">
                            <div className="btn-group" role="group">
                                <button
                                    ...
                                    disabled={isLoading}
                                    title="تصدير الأراكيل إلى Excel"
                                >
                ...
                <div className="col-lg-3 col-md-6">
                    <div className="card border-0 shadow-sm bg-secondary text-white">
                        <div className="card-body text-center">
                            <i className="bi bi-cloud fs-1 mb-2"></i>
                            <h3 className="fw-bold">{products.length}</h3>
                            <p className="mb-0">إجمالي النكهات</p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-3 col-md-6">
                            ...
                            <div className="table-responsive">
                                ...
                                {filteredProducts.length === 0 && (
                                    <div className="text-center py-5">
                                        ...
                                        <p className="text-muted mt-3">لا توجد نكهات متطابقة مع البحث</p>
                                    </div>
                                )}
                            </div>
                        </div>
                                ...
                                <div className="modal-body">
                                    <div className="mb-3">
                                        ...
                                        <input
                                            ...
                                            className="form-control"
                                            placeholder="مثال: نكهات فواكه، نكهات نعناع..."
                                            required
                                            disabled={isLoading}
                                        />
                                    </div>
                        ...
                        <div className="modal-content">
                            ...
                            <form onSubmit={handleAddProduct}>
                                <div className="modal-body">
                                    <div className="row g-3">
                                        <div className="col-md-6">
                                            <label className="form-label fw-semibold">اسم النكهة</label>
                                            <input
                                                type="text"
                                                value={newProduct.name}
                                                onChange={(e) => setNewProduct({ ...newProduct, name: e.target.value })}
                                                className="form-control"
                                                placeholder="مثال: تفاح أحمر، نعناع..."
                                                required
                                                disabled={isLoading}
                                            />
                                        </div>
                                        <div className="col-md-6">
                                            ...
                                            <input
                                                ...
                                                className="form-control"
                                                placeholder="Örn: Kırmızı elma, Nane..."
                                                disabled={isLoading}
                                            />
                                        </div>
                                        <div className="col-md-6">
